"""Force-appends the complete Layer 8 governance JS functions to dashboard.js."""
...
with open(js_path, 'r', encoding='utf-8') as f:
    js = f.read()
fns = ['ragBadge', 'renderGovernancePanel1', 'triggerRetraining', 'showExplanationModal', 'loadGovernance']
for fn in fns:
    print(('OK  ' if fn in js else 'ERR ') + fn)
print('Total file length:', len(js))
