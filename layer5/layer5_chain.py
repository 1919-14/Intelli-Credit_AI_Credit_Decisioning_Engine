        ...
        if hard_rules["gate"] == "HARD_REJECT":
            ...
            rejection_output = {
                "decision_summary": {
                    "decision": "REJECT",
                    "reason": llm_reason,
                    "llm_decision_summary": f"- The application was automatically rejected due to a critical policy violation.\n- Reason: {llm_reason}\n- Please resolve this flagged issue before reapplying.",
